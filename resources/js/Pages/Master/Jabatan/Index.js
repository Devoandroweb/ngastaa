        ...
        <div>
            <div className="toolbar mb-5 mb-lg-7">
                ...
                <div className="d-flex align-items-center py-2 py-md-1" >
                    <Link href={route('master.jabatan.add')} className="btn btn-primary"><b>Tambah</b></Link>
                </div>
            </div>
                ...
                <div className="card mb-5 mb-xl-8">
                    <div className="card-header border-0 pt-5">
                        <h3 className="card-title align-items-start flex-column">
                            <span className="card-label fw-bolder fs-3 mb-1">Data Jabatan</span>
                        </h3>
                    </div>
                                ...
                                <tbody>
                                    {data && data.map((u, k) => (
                                        <tr key={k}>
                                            ...
                                            <td>
                                                <span className="text-dark fw-bolder text-hover-primary fs-6">{u.skpd} <br/> {u.bidang} <br/> {u.seksi}  </span>
                                            </td>
                                            <td>
                                                <p>{u.atasan}</p>
                                            </td>
                                            ...
                                            <td>
                                                <Dropdown>
                                                    <Edit routes={route('master.jabatan.edit', u.id)} />
                                                    <Delete routes={route('master.jabatan.delete', u.id)} />
                                                </Dropdown>
                                            </td>
                                        </tr>
                                    ))}
