...
@section('breadcrumps')
    ...
    {{ Breadcrumbs::render('tambah-management-user-finance') }}
@endsection
@section('content')
@php
...
@endphp
<form class="edit-post-form" action="{{route('users.finance.store')}}" method="post">
    @csrf
    <div class="row">
    ...
    <a href="{{route('users.finance.index')}}" class="btn btn-light">Kembali</a>
