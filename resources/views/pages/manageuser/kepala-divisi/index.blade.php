...
@section('breadcrumps')
    ...
    {{ Breadcrumbs::render('management-user-divisi') }}
@endsection
@section('header_action')
<a href="{{route('users.manager.add')}}" class="btn btn-primary">{!!icons('c-plush')!!} {{__('Tambah')}}</a>
@endsection
...
@push('js')
    <script >
        ...
        var _TABLE = null;
        var _URL_DATATABLE = '{{route("users.manager.datatable")}}';
