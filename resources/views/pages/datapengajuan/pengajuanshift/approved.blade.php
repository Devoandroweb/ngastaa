...
@section('breadcrumps')
    ...
    {{ Breadcrumbs::render('pengajuan-approved-shift') }}
@endsection
@section('content')
<form class="edit-post-form" action="{{route('pengajuan.shift.update')}}" method="post" enctype="multipart/form-data">
    @csrf
    ...
    <a href="{{route('pengajuan.shift.index')}}" class="btn btn-light">Kembali</a>
