...
export default function Index({ lokasi }) {

    const { data, meta } = lokasi
        ...
        <div>
            <div className="toolbar mb-5 mb-lg-7">
                ...
                <div className="d-flex align-items-center py-2 py-md-1" >
                    <Link href={route('master.lokasi.add')} className="btn btn-primary"><b>Tambah</b></Link>
                </div>
            </div>
                ...
                <div className="card mb-5 mb-xl-8">
                    <div className="card-header border-0 pt-5">
                        <h3 className="card-title align-items-start flex-column">
                            <span className="card-label fw-bolder fs-3 mb-1">Data lokasi</span>
                        </h3>
                    </div>
                                ...
                                <tbody>
                                    {data && data.map((u, k) => (
                                        <tr key={k}>
                                            ...
                                            <td>
                                                <span className="text-dark fw-bolder text-hover-primary fs-6">{u.kode_lokasi}</span>
                                            </td>
                                            <td>
                                                <p>{u.nama}</p>
                                            </td>
                                            <td>
                                                <Dropdown>
                                                    <Edit routes={route('master.lokasi.edit', u.id)} />
                                                    <Delete routes={route('master.lokasi.delete', u.id)} />
                                                </Dropdown>
                                            </td>
                                        </tr>
                                    ))}
