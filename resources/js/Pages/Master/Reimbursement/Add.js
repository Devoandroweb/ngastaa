...
export default function Add({ errors, reimbursement }) {

    const [values, setValues] = useState({
        kode_reimbursement: reimbursement.kode_reimbursement,
        nama: reimbursement.nama,
        id: reimbursement.id,
    })
    ...
    const submit = (e) => {
        e.preventDefault();
        Inertia.post(route('master.reimbursement.store'), values);
    }
        ...
        <div>
             <div className="toolbar mb-5 mb-lg-7">
                ...
                <div className="d-flex align-items-center py-2 py-md-1" >
                    <Link href={route('master.reimbursement.index')} className="btn btn-dark"><b>Kembali</b></Link>
                </div>
            </div>
            <div className="card mb-5 mb-xl-8">
                <div className="card-header border-0 pt-5 flex">
                    <h3 className="card-title align-items-start flex-column">
                        <span className="card-label fw-bolder fs-3 mb-1">Tambah Reimbursement</span>
                    </h3>
                </div>
