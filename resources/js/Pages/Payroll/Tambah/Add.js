...
import PayrollTambah from '@/Components/Select/PayrollTambah';
...
export default function Add({ errors, tambah, parent }) {

    const [keterangan, setketerangan] = useState(tambah.kode_keterangan ?? [])
    const [values, setValues] = useState({
        kode_tambah: tambah.kode_tambah,
        bulan: tambah.bulan,
        tahun: tambah.tahun,
        keterangan: tambah.keterangan,
        is_periode: tambah.is_periode,
    ...
    const submit = (e) => {
        e.preventDefault();
        Inertia.post(route('payroll.tambah.store'), values);
    }
            ...
            <div className="toolbar mb-5 mb-lg-7">
                <div className="page-title d-flex flex-column me-3">
                    ...
                    <ul className="breadcrumb breadcrumb-dot fw-bold text-gray-600 fs-7 my-1">
                        ...
                        <li className="breadcrumb-item text-gray-600">Tambahan</li>
                        <li className="breadcrumb-item text-gray-500">Tambah Data</li>
                    </ul>
                </div>
                <div className="d-flex align-items-center py-2 py-md-1" >
                    <Link href={route('payroll.tambah.index')} className="btn btn-dark"><b>Kembali</b></Link>
                </div>
            </div>
            <div className="card mb-5 mb-xl-8">
                <div className="card-header border-0 pt-5 flex">
                    <h3 className="card-title align-items-start flex-column">
                        <span className="card-label fw-bolder fs-3 mb-1">Data Tambahan Payroll</span>
                    </h3>
                </div>
                    ...
                    <form onSubmit={submit}>
                        <div className="row mb-6">
                            ...
                            <div className="col-lg-9 fv-row fv-plugins-icon-container">
                                <PayrollTambah valueHandle={values.kode_tambah} onchangeHandle={(e) => changeSelect(e, 'kode_tambah')} />
                            </div>
                            {errors.kode_tambah && <div className="text-danger">{errors.kode_tambah}</div>}
                        </div>
                        <div className="row mb-6">
                        ...
                        }
                        {
                            ...
                            <div className="row mb-6">
                                ...
                                <div className="col-lg-9 fv-row fv-plugins-icon-container">
                                    <Cascader data={parent} value={keterangan.toString()} onChange={changeKeterangan} parentSelectable style={{ width: '100%' }} />
                                </div>
                                {errors.kode_keterangan && <div className="text-danger">{errors.kode_keterangan}</div>}
                            </div>
                        }
