...
@section('breadcrumps')
    ...
    {{ Breadcrumbs::render('tingkat-pendidikan') }}
@endsection
@section('header_action')
<a href="{{route('master.pendidikan.add')}}" class="btn btn-primary">{!!icons('c-plush')!!} {{__('Tambah')}}</a>
@endsection
@section('content')
@if(session('messages'))
...
@endif
<table id="data" class="table mt-2 nowrap w-100 mb-5 table-bordered">
    <thead>
...
@push('js')
    <script >
        ...
        var _TABLE = null;
        var _URL_DATATABLE = '{{url("master/pendidikan/datatable")}}';
