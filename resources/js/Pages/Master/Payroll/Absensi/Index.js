                ...
                <div className="card mb-5 mb-xl-8">
                    <div className="card-header border-0 pt-5">
                        <h3 className="card-title align-items-start flex-column">
                            <span className="card-label fw-bolder fs-3 mb-1">Data Absensi</span>
                        </h3>
                    </div>
                                ...
                                <tbody>
                                    {data && data.map((u, k) => (
                                        <tr key={k}>
                                            ...
                                            <td>
                                                <span className="text-dark fw-bolder text-hover-primary fs-6">{u.keterangan}</span>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <Edit routes={route('master.payroll.absensi.edit', u.id)} />
                                            </td>
                                        </tr>
                                    ))}
                                </tbody>
