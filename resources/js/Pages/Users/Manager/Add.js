...
export default function Add({ users }) {
    ...
    const submit = (e) => {
        e.preventDefault();
        Inertia.post(route('users.manager.store'), values);
    }
        ...
        <div>
            <div className="toolbar mb-5 mb-lg-7">
                ...
                <div className="d-flex align-items-center py-2 py-md-1" >
                    <Link href={route('users.manager.index')} className="btn btn-dark"><b>Kembali</b></Link>
                </div>
            </div>
            <div className="card mb-5 mb-xl-8">
                <div className="card-header border-0 pt-5 flex">
                    <h3 className="card-title align-items-start flex-column">
                        <span className="card-label fw-bolder fs-3 mb-1">Tambah  Kepala Divisi</span>
                    </h3>
                </div>
