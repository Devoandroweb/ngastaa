...
<form class="edit-post-form" action="{{url('pegawai/keluarga/store')}}" method="post">
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="form-group has-validation">
                <input class="form-control mb-3 @error('nama') is-invalid @enderror"  placeholder="Masukkan Nama" name="nama">
    ...
    <div class="row">
        ...
        <div class="col-md-8">
            <div class="form-group">
                <input class="form-control mb-3 @error('tempat_lahir') is-invalid @enderror" placeholder="Masukkan Tempat Lahir" name="tempat_lahir">
                <div class="invalid-feedback">
    ...
    <div class="row">
        ...
        <div class="col-md-8">
            <div class="form-group">
                <input class="form-control mb-3 @error('tanggal_lahir') is-invalid @enderror" placeholder="Masukkan Tanggal Lahir" name="tanggal_lahir" type="date" >
                <div class="invalid-feedback">
    ...
    <div class="row">
        ...
        <div class="col-md-8">
            <div class="form-group">
                <textarea class="form-control mb-3 @error('alamat') is-invalid @enderror" placeholder="Masukkan Alamat" name="alamat" rows="3" >
                <div class="invalid-feedback">
                    {{ $errors->first('alamat') }}
                </div>
            </div>
    ...
    <div class="row">
        ...
        <div class="col-md-8">
            <div class="form-group">
                <input class="form-control mb-3 @error('nomor_ktp') is-invalid @enderror" placeholder="Masukkan Nomor Ktp" name="nomor_ktp">
                <div class="invalid-feedback">
    ...
    <div class="row">
        ...
        <div class="col-md-8">
            <div class="form-group">
                <input class="form-control mb-3 @error('file_ktp') is-invalid @enderror" placeholder="Masukkan Unggah Ktp" name="file_ktp" type="file">
                <div class="invalid-feedback">
    ...
    <div class="row">
        ...
        <div class="col-md-8">
            <div class="form-group">
                <input class="form-control mb-3 @error('nomor_bpjs') is-invalid @enderror" placeholder="Masukkan Nomor Bpjs" name="nomor_bpjs">
                <div class="invalid-feedback">
    ...
    <div class="row">
        ...
        <div class="col-md-8">
            <div class="form-group">
                <input class="form-control mb-3 @error('file_bpjs') is-invalid @enderror" placeholder="Masukkan Unggah Bpjs" name="file_bpjs" type="file" >
                <div class="invalid-feedback">
