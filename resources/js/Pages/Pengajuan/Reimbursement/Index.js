...
export default function Index({ reimbursement }) {

    const { data, meta } = reimbursement
            ...
            <div className="toolbar mb-5 mb-lg-7">
                <div className="page-title d-flex flex-column me-3">
                    ...
                    <ul className="breadcrumb breadcrumb-dot fw-bold text-gray-600 fs-7 my-1">
                        ...
                        <li className="breadcrumb-item text-gray-600">Reimbursement</li>
                    </ul>
                </div>
            </div>
                ...
                <div className="card mb-5 mb-xl-8">
                    <div className="card-header border-0 pt-5">
                        <h3 className="card-title align-items-start flex-column">
                            <span className="card-label fw-bolder fs-3 mb-1">Data Pengajuan Reimbursement</span>
                        </h3>
                    </div>
                                ...
                                <tbody>
                                    {data && data.map((u, k) => (
                                        <tr key={k}>
                                            ...
                                            <td>
                                                <div className="text-dark fw-bolder text-hover-primary fs-6">{u.reimbursement}</div>
                                            </td>
                                            <td>
                                                <p>{u.nilai}</p>
                                            </td>
                                            ...
                                            <td>
                                                <Dropdown>
                                                    <Logs model_type="App\Pegawai\DataPengajuanreimbursement" model_id={u.id} />
                                                    {
                                                        u.kode_status == 0 ?
                                                            <>
                                                                <Reject routes={route('pengajuan.reimbursement.reject', u.id)} />
                                                                <Approved routes={route('pengajuan.reimbursement.approved', u.id)} />
                                                            </>
                                                            : ""
                                                    }
                                                </Dropdown>
