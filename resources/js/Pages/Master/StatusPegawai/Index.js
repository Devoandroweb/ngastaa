...
export default function Index({ status_pegawai }) {

    const { data, meta } = status_pegawai
        ...
        <div>
            <div className="toolbar mb-5 mb-lg-7">
                ...
                <div className="d-flex align-items-center py-2 py-md-1" >
                    <Link href={route('master.status_pegawai.add')} className="btn btn-primary"><b>Tambah</b></Link>
                </div>
            </div>
                ...
                <div className="card mb-5 mb-xl-8">
                    <div className="card-header border-0 pt-5">
                        <h3 className="card-title align-items-start flex-column">
                            <span className="card-label fw-bolder fs-3 mb-1">Data Status pegawai</span>
                        </h3>
                    </div>
                                ...
                                <tbody>
                                    {data && data.map((u, k) => (
                                        <tr key={k}>
                                            ...
                                            <td>
                                                <span className="text-dark fw-bolder text-hover-primary fs-6">{u.kode_status}</span>
                                            </td>
                                            <td>
                                                <p>{u.nama}</p>
                                            </td>
                                            <td>
                                                <Dropdown>
                                                    <Edit routes={route('master.status_pegawai.edit', u.id)} />
                                                    <Delete routes={route('master.status_pegawai.delete', u.id)} />
                                                </Dropdown>
                                            </td>
                                        </tr>
                                    ))}
