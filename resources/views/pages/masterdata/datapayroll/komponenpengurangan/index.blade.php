...
@section('breadcrumps')
    ...
    {{ Breadcrumbs::render('pengurangan') }}
@endsection
@section('header_action')
<a href="{{route('master.payroll.pengurangan.add')}}" class="btn btn-primary">{!!icons('c-plush')!!} {{__('Tambah')}}</a>
@endsection
@section('content')
@if(session('messages'))
...
@push('js')
    <script >
        ...
        var _TABLE = null;
        var _URL_DATATABLE = '{{url("master/payroll/pengurangan/datatable")}}';
