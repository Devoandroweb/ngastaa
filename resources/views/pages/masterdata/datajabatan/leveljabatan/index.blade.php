...
@section('breadcrumps')
    ...
    {{ Breadcrumbs::render('level-jabatan') }}
@endsection
@section('header_action')
<a href="{{route('master.eselon.add')}}" class="btn btn-primary">{!!icons('c-plush')!!} {{__('Tambah')}}</a>
@endsection
...
@push('js')
    <script >
        ...
        var _TABLE = null;
        var _URL_DATATABLE = '{{url("master/level/datatable")}}';
        ...
        function setDataTable() {
            _TABLE = $('#data').DataTable({
                ...
                language:{
                    searchPlaceholder: "Cari Level Jabatan",
                    search: ""
                },
                columns: [{
                        "data": 'DT_RowIndex',
