...
export default function Index({ pengurangan }) {

    const { data, meta } = pengurangan
        ...
        <div>
            <div className="toolbar mb-5 mb-lg-7">
                ...
                <div className="d-flex align-items-center py-2 py-md-1" >
                    <Link href={route('master.payroll.pengurangan.add')} className="btn btn-primary"><b>Tambah</b></Link>
                </div>
            </div>
                ...
                <div className="card mb-5 mb-xl-8">
                    <div className="card-header border-0 pt-5">
                        <h3 className="card-title align-items-start flex-column">
                            <span className="card-label fw-bolder fs-3 mb-1">Data Komponen Pengurangan Payroll</span>
                        </h3>
                    </div>
                                    ...
                                    {data && data.map((u, k) => (
                                        <tr key={k}>
                                            ...
                                            <td>
                                                ...
                                                {
                                                    u.satuan == 2 &&
                                                    <span className="text-dark fw-bolder text-hover-primary fs-6">Dari {u.dari}</span>
                                                }
                                            </td>
                                            <td>
                                                <Dropdown>
