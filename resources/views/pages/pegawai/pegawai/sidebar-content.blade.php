		...
		<div data-simplebar class="nicescroll-bar">
			<div class="menu-content-wrap" id="sidebar-content">
				<div class="menu-group">
					<ul class="nav nav-light navbar-nav flex-column">
						<li class="nav-item active">
							<a class="nav-link tab-utama" href="#data_pribadi" data-ajax="{{route('pegawai.pegawai.detail_pribadi',$pegawai->nip)}}">
						...
						<li class="nav-item">
							<a class="nav-link tab-utama" href="#posisi_jabatan" data-ajax="{{route('pegawai.posisi.index',$pegawai->nip)}}">
								<span class="nav-icon-wrap">{!!icons('c-arror-right')!!}</span>
								<span class="nav-link-text">Posisi dan Jabatan</span>
							</a>
						</li>
                        <li class="nav-item">
							<a class="nav-link tab-utama" href="#data_koor" id="tab-koor" data-ajax="{{route('pegawai.kordinat.index',$pegawai->nip)}}">
								<span class="nav-icon-wrap">{!!icons('c-arror-right')!!}</span>
                ...
                <div class="menu-group">
					<ul class="nav nav-light navbar-nav flex-column">
						<li class="nav-item">
                            <a class="nav-link tab-datatable" data-tipepage="21" href="#jabatan"
                        ...
                        <li class="nav-item">
                            <a class="nav-link tab-datatable" data-tipepage="22" href="#gaji_pokok"
                        ...
                        <li class="nav-item">
                            <a class="nav-link tab-datatable" data-tipepage="23" href="#data_tunjangan"
                        ...
                        <li class="nav-item">
                            <a class="nav-link tab-datatable" data-tipepage="24" href="#data_potongan"
                        ...
                        <li class="nav-item">
                            <a class="nav-link tab-datatable" data-tipepage="25" href="#data_pendidikan"
                        ...
                        <li class="nav-item">
                            <a class="nav-link tab-datatable" data-tipepage="26"  href="#data_kursus"
                        ...
                        <li class="nav-item">
                            <a class="nav-link tab-datatable" data-tipepage="27"  href="#data_cuti" 
                        ...
                        <li class="nav-item">
                            <a class="nav-link tab-datatable" data-tipepage="28" href="#data_lembur"
                        ...
                        <li class="nav-item">
                            <a class="nav-link tab-datatable" data-tipepage="29"  href="#data_reimbursement"
                            ...
                            <a class="nav-link tab-datatable" data-tipepage="30"  href="#data_shift"
                        ...
                        <li class="nav-item">
                            <a class="nav-link tab-datatable" data-tipepage="31"  href="#data_penghargaan"
                ...
                <div class="menu-group">
                    <ul class="nav nav-light navbar-nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link tab-datatable" href="#orang_tua" 
                        ...
                        <li class="nav-item">
                            <a class="nav-link tab-datatable" href="#data_koor"
                ...
                <div class="menu-group">
                    <ul class="nav nav-light navbar-nav flex-column">
                        <li class="nav-item">
                            <a class="nav-link tab-datatable" href="#data_organisasi"
                        ...
                        <li class="nav-item">
                            <a class="nav-link tab-datatable"  href="#penguasaan_bahasa"
                        ...
                        <li class="nav-item ">
                            <a class="nav-link tab-datatable" data-tipepage="33" href="#pengalaman"
                        ...
                        <li class="nav-item">
                            <a class="nav-link tab-datatable" data-tipepage="32" href="#riwayatlainnya"
