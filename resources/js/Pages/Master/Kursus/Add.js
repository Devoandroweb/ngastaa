...
export default function Add({ errors, kursus }) {

    const [values, setValues] = useState({
        kode_kursus: kursus.kode_kursus,
        nama: kursus.nama,
        id: kursus.id,
    })
    ...
    const submit = (e) => {
        e.preventDefault();
        Inertia.post(route('master.kursus.store'), values);
    }
             ...
             <div className="toolbar mb-5 mb-lg-7">
                <div className="page-title d-flex flex-column me-3">
                    ...
                    <ul className="breadcrumb breadcrumb-dot fw-bold text-gray-600 fs-7 my-1">
                        ...
                        <li className="breadcrumb-item text-gray-600">Kursus</li>
                        <li className="breadcrumb-item text-gray-500">Data</li>
                    </ul>
                </div>
                <div className="d-flex align-items-center py-2 py-md-1" >
                    <Link href={route('master.kursus.index')} className="btn btn-dark"><b>Kembali</b></Link>
                </div>
            </div>
            <div className="card mb-5 mb-xl-8">
                <div className="card-header border-0 pt-5 flex">
                    <h3 className="card-title align-items-start flex-column">
                        <span className="card-label fw-bolder fs-3 mb-1">Tambah Kursus & Pelatihan</span>
                    </h3>
                </div>
                    ...
                    <form onSubmit={submit}>
                        <div className="row mb-6">
                            ...
                            <div className="col-lg-9 fv-row fv-plugins-icon-container">
                                <input name="kode_kursus" disabled={values.id != undefined ? true : false} type="number" onChange={updateData} value={values.kode_kursus} className="form-control form-control-lg form-control-solid" />
                            </div>
