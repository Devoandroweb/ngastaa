@extends('app')
@section('breadcrumps')
    <h2 class="pg-title">Pengajuan Lembur</h2>
    {{ Breadcrumbs::render('pengajuan-approved-lembur') }}
@endsection
@section('content')
<form class="edit-post-form" action="{{route('pengajuan.lembur.update')}}" method="post" enctype="multipart/form-data">
    @csrf
    ...
    <a href="{{route('pengajuan.lembur.index')}}" class="btn btn-light">Kembali</a>
