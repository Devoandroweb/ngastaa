...
export default function Index({ penghargaan }) {

    const { data, meta } = penghargaan
            ...
            <div className="toolbar mb-5 mb-lg-7">
                <div className="page-title d-flex flex-column me-3">
                    ...
                    <ul className="breadcrumb breadcrumb-dot fw-bold text-gray-600 fs-7 my-1">
                        ...
                        <li className="breadcrumb-item text-gray-600">Penghargaan</li>
                        <li className="breadcrumb-item text-gray-500">Index</li>
                    </ul>
                </div>
                <div className="d-flex align-items-center py-2 py-md-1" >
                    <Link href={route('master.penghargaan.add')} className="btn btn-primary"><b>Tambah</b></Link>
                </div>
            </div>
                ...
                <div className="card mb-5 mb-xl-8">
                    <div className="card-header border-0 pt-5">
                        <h3 className="card-title align-items-start flex-column">
                            <span className="card-label fw-bolder fs-3 mb-1">Data Penghargaan</span>
                        </h3>
                    </div>
