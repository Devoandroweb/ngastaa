...
export default function Index({ golongan }) {

    const { data, meta } = golongan
        ...
        <div>
            <div className="toolbar mb-5 mb-lg-7">
                ...
                <div className="d-flex align-items-center py-2 py-md-1" >
                    <Link href={route('master.golongan.add')} className="btn btn-primary"><b>Tambah</b></Link>
                </div>
            </div>
                ...
                <div className="card mb-5 mb-xl-8">
                    <div className="card-header border-0 pt-5">
                        <h3 className="card-title align-items-start flex-column">
                            <span className="card-label fw-bolder fs-3 mb-1">Data Golongan</span>
                        </h3>
                    </div>
                            ...
                            <table className="table table-row-bordered table-row-gray-100 align-middle gs-0 gy-3 min-h-200px">
                                <thead>
                                    <tr className="fw-bolder text-muted">
                                        ...
                                        <th>Kode Golongan</th>
                                        <th>Pangkat</th>
                                        <th>Nama Golongan (Romawi)</th>
                                        <th>Nama Golongan (Abjad)</th>
                                        <th>Opsi</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    {data && data.map((u, k) => (
                                        <tr key={k}>
                                            ...
                                            <td>
                                                <span className="text-dark fw-bolder text-hover-primary fs-6">{u.kode_golongan}</span>
                                            </td>
                                            <td>
                                                <p>{u.pangkat}</p>
                                            </td>
                                            ...
                                            <td>
                                                <Dropdown>
                                                    <Edit routes={route('master.golongan.edit', u.id)} />
                                                    <Delete routes={route('master.golongan.delete', u.id)} />
                                                </Dropdown>
                                            </td>
                                        </tr>
                                    ))}
